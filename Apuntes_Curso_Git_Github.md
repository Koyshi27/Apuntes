...
- **git commit -m “mensaje”**: guardar el archivo en git con un mensaje. Cuando se hace un commit y aparece la otra pantalla, para salir hay que usar: Esc + Shif + z + z
- **git commit -am "commit message"**: Esta combinación crea inmediatamente una confirmación de todos los cambios preparados y aplica un mensaje de confirmación insertado.
